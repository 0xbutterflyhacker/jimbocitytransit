SMODS.Joker { --9
    ...
    loc_vars = function(self, info_queue, card)
        local new_numerator, new_denominator = SMODS.get_probability_vars(card, card.ability.extra.discontinueMult,
            card.ability.extra.odds, 'j_jctransit__9')
                    ...
                    extra = {
                        ...
                        func = function()
                            ...
                            card_eval_status_text(context.blueprint_card or card, 'extra', nil, nil, nil,
                                { message = "+" .. tostring(9), colour = G.C.MONEY })
                            return true
                        end,
                        colour = G.C.MONEY
                    }
