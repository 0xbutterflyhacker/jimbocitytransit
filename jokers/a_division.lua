...
SMODS.Joker { --1 (Broadway-7th Ave Lcl)
    ...
    loc_txt = {
        name = '1',
        text = { '{C:mult}+#3# {}Mult for every {C:Heart}Heart {}card played',
            '#1# in #2# chance to start skip-stop service' }
    },
    atlas = 'CustomJokersA',
    pos = { x = 0, y = 0 },
    rarity = 1,
    cost = 3,
    config = { extra = { mult = 7, suit = 'Heart', numerator = 1, denominator = 16, jbc_type = 'route' } },
...
SMODS.Joker { --2 (Broadway-7th Ave Exp)
    ...
    loc_txt = {
        name = '2',
        text = { '{C:mult}+7 {}Mult for every {C:Heart}Heart {}card played' }
    },
    atlas = 'CustomJokersA',
    pos = { x = 0, y = 0 },
    rarity = 1,
    cost = 3,
    config = { extra = { mult = 7, suit = 'Heart', jbc_type = 'route' } },
...
SMODS.Joker { --9 (Broadway-7th Ave Lcl/Skip-Stop)
    ...
    loc_txt = {
        name = '9',
        text = { '{C:mult}+7 {}Mult for every {C:Heart}Heart {}card played',
            '#1# in #2# chance for {C:Xmult}x#5# {}Mult for every {C:Heart}Heart {}card played',
    ...
    rarity = 3,
    cost = 9,
    config = { extra = { mult = 7, xmult = 1.6, suit = 'Heart', numeratorA = 1, numeratorB = 1, denominatorA = 2, denominatorB = 9, jbc_type = 'vintage_route' } },
    loc_vars = function(self, info_queue, card)
        ...
        return { vars = { numA, denomA, numB, denomB, card.ability.extra.xmult } }
    end,
